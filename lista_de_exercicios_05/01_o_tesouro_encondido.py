""" Descrição: Um mapa do tesouro tem duas partes, A e B. A primeira parte está escondida no X
...
a = int(input('Digite o numero X de passos: '))
b = int(input('Digite o numero Y de passos: '))

print(f'Distancia total: {a + b} passos')